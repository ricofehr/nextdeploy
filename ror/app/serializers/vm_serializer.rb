...
class VmSerializer < ActiveModel::Serializer
  attributes :id, :nova_id, :floating_ip, :vnc_url, :created_at, :name, :status, :is_auth, :htlogin, :htpassword, :termpassword, :layout, :is_prod, :is_cached, :is_ht, :is_ci, :is_backup
